    ...
    <section className="py-5 bg-white" id="gallery">
      <div className="container py-5">
        ...
        <div className="text-center mb-5">
          <h2 className="fw-bold text-dark display-6 mb-2">Galeri Foto</h2>
          <p className="text-muted small text-uppercase fw-semibold ls-2">Dokumentasi Terkini Al-Kautsar</p>
        </div>
