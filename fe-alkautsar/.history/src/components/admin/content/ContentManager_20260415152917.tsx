  ...
  <div style="display:flex; flex-direction:column; gap:16px;">
      ...
      <div id="color-picker" class="color-grid">
        ${[
          ...
          .map(
            (color) => `
            <div 
              class="color-item ${initialValue.accent === color ? "active" : ""}"
              data-color="${color}"
    ...
    ${modalHtml(
      [
        ...
        modalInput("promo-button-text", "Tombol Utama", initialValue.buttonText, "Lihat Detail"),
        modalInput("promo-detail-text", "Tombol Detail", initialValue.detailText, "Detail Info"),
      ].join("")
    )}

    <div style="display:flex; justify-content:flex-end; margin-top:10px;">
      <button id="btn-save-promo" class="btn-save">
        💾 Simpan Promo
      </button>
    </div>
        ...
        btn.addEventListener("click", async () => {
          try {
            ...
            const nextPromo: PromoItem = {
              ...
              image: imageValue, // 🔥 dari file/base64
