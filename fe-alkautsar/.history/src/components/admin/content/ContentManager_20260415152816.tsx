    ...
    html: `
      ${modalHtml(
        [
          ...
          // 🔥 COLOR PICKER
          `
          <div class="student-modal-field student-modal-field--full">
            <span>Pilih Warna Accent</span>
            <div id="color-picker" style="display:flex; gap:10px; flex-wrap:wrap; margin-top:8px;">
              ${[
                "#0f766e",
                "#2563eb",
                "#9333ea",
          ...
          <label class="student-modal-field student-modal-field--full">
            ...
            <input id="promo-image-file" type="file" accept="image/*" class="swal2-file" />
          </label>
          `,
        ...
        btn.addEventListener("click", async () => {
          try {
            ...
            const nextPromo: PromoItem = {
              ...
              accent: selectedColor, // 🔥 dari color picker
              image: imageValue,
            ...
            if (!nextPromo.title || !nextPromo.text) {
              Swal.showValidationMessage(
                "Judul dan deskripsi promo wajib diisi."
              );
              return;
            }
