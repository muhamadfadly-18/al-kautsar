...
const ContentManager = () => {
  ...
  await Swal.fire({
    title: index === undefined ? "Tambah Foto Gallery" : `Edit Foto #${index + 1}`,
    html: `
    ...
    didOpen: () => {
      ...
      const fileInput = document.getElementById("gallery-image-file") as HTMLInputElement;
        ...
        try {
          ...
          setContent((prev) => ({
            ...
            gallery: index === undefined
              ...
              : prev.gallery.map((item, i) => i === index ? nextItem : item),
          }));
