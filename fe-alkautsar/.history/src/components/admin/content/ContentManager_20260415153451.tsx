    ...
    html: `
      <div style="text-align: left; font-family: 'Segoe UI', Roboto, sans-serif; color: #1f2937;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 12px; padding: 16px; background: #eff6ff; border-radius: 12px; border: 1px solid #dbeafe;">
            ...
            ${modalInput("banner-primary-label", "Label", banner.primaryLabel, "Contoh: Mulai Sekarang")}
            ${modalInput("banner-primary-href", "Link Target", banner.primaryHref, "#")}
          </div>

          <div style="display: flex; flex-direction: column; gap: 12px; padding: 16px; background: #f9fafb; border-radius: 12px; border: 1px solid #f3f4f6;">
            ...
            ${modalInput("banner-secondary-label", "Label", banner.secondaryLabel, "Contoh: Pelajari")}
