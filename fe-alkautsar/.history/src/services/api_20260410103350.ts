...
export const getHomeContent = async (): Promise<HomeContent> => {
  try {
    ...
    console.log("📦 Payload setelah unwrap:", payload);
    ...
    console.log("✅ Hasil final (API utama):", result);
    ...
    console.warn("⚠️ API utama 404, fallback ke endpoint satuan...");
  }

  console.log("🔄 Mulai fallback fetch...");
  ...
  console.log("✅ Hasil fallback:", fallbackResult);
