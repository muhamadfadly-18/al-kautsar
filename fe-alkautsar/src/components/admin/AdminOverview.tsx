  ...
  <>
    <header className="admin-hero">
      <div className="admin-hero__highlight">
        ...
        <strong>Selamat datang kembali, {adminName}</strong>
        <p>
          Kelola siswa, konten website, organisasi, laporan PPDB, dan pengaturan
          admin dari satu dashboard yang nyaman dipakai di semua ukuran layar.
        </p>
      </div>
